...
// 	ctx.font = "30px Arial";
// 	let text = document.getElementById("the_text").text();
// 	// let text = t;
...
// 	let the_text = document.getElementById("the_text");
// 	the_text.text = t;
...
// 	document.getElementById("show_img_here").append(img);
// };
//https://stackoverflow.com/questions/43905570/converting-html-text-to-an-image-javascript
const png = (t)=>{
	let size = 100;
	let the_text = document.getElementById("the_text");

	the_text.style.fontSize = `${size}px`;
	// the_text.text = t;
	the_text.innerHTML = t;

	console.log(the_text.offsetWidth,the_text.offsetHeight)
	...
	// canvas.width = the_text.offsetWidth;
	canvas.width = the_text.offsetWidth + 10;
	// canvas.height = the_text.offsetHeight;
	// canvas.height = 80;
	canvas.height = the_text.offsetHeight * 2;
	...
	// ctx.fillText(t,(the_text.offsetWidth / 2),(the_text.offsetHeight / 2));
	// ctx.fillText(t,10,(the_text.offsetHeight / 2));
	// ctx.fillText(t,0,0);
